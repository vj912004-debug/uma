...
<div class="print-host">
  <div class="qtn-page pdf-page">
    ...
    <!-- Letter with Machine Image -->
    <div style="display: flex; gap: 15px; margin-bottom: 12px;">
        <div class="qtn-letter" style="flex: 1;">
        ...
        <div style="width: 250px; border-radius: 6px; overflow: hidden; border: 1.5px solid var(--border-purple); display: flex; align-items: center; justify-content: center; background-color: #f5f5f5;">
            <div style="text-align: center; color: #aaa;">
                <i class="bi bi-camera" style="font-size: 32px;"></i>
                <div style="font-size: 10px; margin-top: 4px;">Facility Image</div>
            </div>
        </div>
    </div>
        ...
        <div class="qtn-box" style="flex: 1.4;">
            ...
            <table class="qtn-table">
                ...
                <tr>
                    ...
                    <td style="border-right: none;">&mdash;</td>
                </tr>
                `).join('')}
            </table>
        </div>
