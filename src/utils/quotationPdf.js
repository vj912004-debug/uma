...
export const buildQuotationHtml = (data, profileInput) => {
  ...
  const savedTerms = String(data.terms || '').split(/\r?\n/).map((line) => line.trim()).filter(Boolean);
        ...
        <div style="width: 70%; display: flex; flex-direction: column; justify-content: space-between;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                ...
                <div class="qtn-letter">
                    ...
                    ${descriptionHtml ? `<p style="margin-bottom: 8px;">${descriptionHtml}</p>` : ''}
                ...
                <div class="qtn-box">
                    ...
                    <div class="qtn-box-body">
                        <ul style="padding-left: 15px; margin: 0; font-size: 10px;">
                            ${savedTerms.length
                              ? savedTerms.map((line) => `<li style="margin-bottom: 6px;">${escHtml(line)}</li>`).join('')
                              : `
        ...
        <div style="display: flex; gap: 15px;">
            ...
            <div class="qtn-box outline-only" style="flex: 1;">
                ...
                <div class="qtn-box-body">
                    <ul style="padding-left: 15px; margin: 0; font-size: 10px;">
                        ${savedNotes.length
                          ? savedNotes.map((line) => `<li style="margin-bottom: 8px;">${escHtml(line)}</li>`).join('')
                          : `
